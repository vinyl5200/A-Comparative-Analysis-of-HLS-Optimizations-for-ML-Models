...
void myproject(
    ...
    //#pragma HLS ARRAY_PARTITION variable=layer2_out complete dim=0
        #pragma HLS ARRAY_PARTITION variable=layer2_out block factor=8
    ...
    #pragma HLS ARRAY_PARTITION variable=layer3_out block factor=8
