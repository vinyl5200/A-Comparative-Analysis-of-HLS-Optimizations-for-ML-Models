...
architecture behav of relu_ap_fixed_16_6_5_3_0_ap_fixed_16_6_5_3_0_relu_config7_s is 
    ...
    signal ii_2_fu_287_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal ii_2_reg_371 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal tmp_28_fu_352_p1 : STD_LOGIC_VECTOR (14 downto 0);
    signal tmp_28_reg_466 : STD_LOGIC_VECTOR (14 downto 0);
    signal datareg_V_2_fu_361_p3 : STD_LOGIC_VECTOR (14 downto 0);
    signal datareg_V_2_reg_471 : STD_LOGIC_VECTOR (14 downto 0);
    ...
    signal tmp_27_fu_303_p1 : STD_LOGIC_VECTOR (3 downto 0);
...
begin
    myproject_mux_832_16_1_1_U617 : component myproject_mux_832_16_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 16,
    ...
    datareg_V_2_fu_361_p3 <= 
        tmp_28_reg_466 when (tmp_s_fu_356_p2(0) = '1') else 
        ap_const_lv15_0;
    datareg_V_fu_330_p9 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(arrayNo_reg_376),32));
    ii_2_fu_287_p2 <= std_logic_vector(unsigned(ii_reg_270) + unsigned(ap_const_lv8_1));
    newIndex_fu_307_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_27_fu_303_p1),64));
    ...
    res_0_V_d0 <= datareg_V_2_reg_471;
    ...
    res_1_V_d0 <= datareg_V_2_reg_471;
    ...
    res_2_V_d0 <= datareg_V_2_reg_471;
    ...
    res_3_V_d0 <= datareg_V_2_reg_471;
    ...
    res_4_V_d0 <= datareg_V_2_reg_471;
    ...
    res_5_V_d0 <= datareg_V_2_reg_471;
    ...
    res_6_V_d0 <= datareg_V_2_reg_471;
    ...
    res_7_V_d0 <= datareg_V_2_reg_471;
    ...
    tmp_27_fu_303_p1 <= ii_reg_270(4 - 1 downto 0);
    tmp_28_fu_352_p1 <= datareg_V_fu_330_p10(15 - 1 downto 0);
