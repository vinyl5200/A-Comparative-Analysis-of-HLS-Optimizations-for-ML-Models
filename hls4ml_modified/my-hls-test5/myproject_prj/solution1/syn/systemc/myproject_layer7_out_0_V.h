...
public:
    ...
    SC_CTOR(myproject_layer7_out_0_V) : m_trace_file(0) {
        ...
        myproject_layer7_out_0_V_memcore_U = new myproject_layer7_out_0_V_memcore("myproject_layer7_out_0_V_memcore_U");
        myproject_layer7_out_0_V_memcore_U->clk      ( clk );
        myproject_layer7_out_0_V_memcore_U->reset    ( reset );
        myproject_layer7_out_0_V_memcore_U->ce0      ( i_ce0 );
        myproject_layer7_out_0_V_memcore_U->we0      ( i_we0 );
        myproject_layer7_out_0_V_memcore_U->address0 ( memcore_iaddr );
        myproject_layer7_out_0_V_memcore_U->d0       ( i_d0 );
        myproject_layer7_out_0_V_memcore_U->q0       ( i_q0 );

        myproject_layer7_out_0_V_memcore_U->ce1      ( t_ce0 );
        myproject_layer7_out_0_V_memcore_U->we1      ( t_we0 );
        myproject_layer7_out_0_V_memcore_U->address1 ( memcore_taddr );
        myproject_layer7_out_0_V_memcore_U->d1       ( t_d0 );
        myproject_layer7_out_0_V_memcore_U->q1       ( t_q0 );
