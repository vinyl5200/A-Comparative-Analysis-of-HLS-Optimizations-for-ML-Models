...
#ifndef __myproject_mul_16s_9ns_25_2_1__HH__
#define __myproject_mul_16s_9ns_25_2_1__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(myproject_mul_16s_9ns_25_2_1) {
    ...
    SC_CTOR(myproject_mul_16s_9ns_25_2_1):  ACMP_mul_su_U ("ACMP_mul_su_U") {
