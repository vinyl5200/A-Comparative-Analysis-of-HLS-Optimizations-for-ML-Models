...
#ifndef _myproject_layer10_out_0_V_H_
#define _myproject_layer10_out_0_V_H_

#include <systemc>
#include <iostream>
#include <fstream>

#include "myproject_layer10_out_0_V_memcore.h"

SC_MODULE(myproject_layer10_out_0_V) {
...
protected:
    ...
    // buffer instances
    myproject_layer10_out_0_V_memcore* buffer[BufferCount];
...
public:
    ...
    SC_CTOR(myproject_layer10_out_0_V) : m_trace_file(0) {
        for (unsigned i = 0; i < BufferCount; i++) {
            char szTmp[128];
            sprintf(szTmp, "%d", i);
            std::string name = "myproject_layer10_out_0_V_memcore_U_";
            name += szTmp;

            buffer[i] = new myproject_layer10_out_0_V_memcore(name.c_str());
            buffer[i]->clk      ( clk );
        ...
        if (dump_vcd) {
            m_trace_file = sc_create_vcd_trace_file( "myproject_layer10_out_0_V.trace");
            // ports
